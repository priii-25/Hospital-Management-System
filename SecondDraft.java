...
{
    ArrayList<String> timeSlots=new ArrayList<>(List.of("1. 9am-10am","2. 10am to 11am","3. 11am-12 noon","4. 12 noon to 1pm","5. 3pm-4pm","6. 4pm-5pm","7. 5pm-6pm"));
    void slotsDisplay(){
...
public class SecondDraft 
{
    ...
    public static void main(String args[])
    {
        ...
        int count=0;
        CreatePortal[] patient = new CreatePortal[10];
        while (true) 
        {
            ...
            System.out.println("4. Feedback Portal");
            ...
            switch (choice) 
            {
                case 1:
                    ...
                    System.out.print("please enter few contact information");
    ...
    /**
     * 
     * @param patient it accpets the object, patient in this case and displays the patient's details
     */
